 ...
 * 2. Изображение: rounded w-full h-56 object-cover  ← увеличена высота
...
const products: Product[] = [
  {
    ...
    name: 'Наушники',
    price: 5990,
    image: 'https://avatars.mds.yandex.net/i?id=01073023d6e4d09d708853ac3613c310_l-5236752-images-thumbs&n=13'
  },
  {
    id: 2,
    name: 'Смарт-часы',
    price: 12990,
    image: 'https://hocotech.com/wp-content/uploads/2021/11/hoco-y2-smart-watch-waterproof.jpg'
  }
];
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {products.map(product => (
          <div
            key={product.id}
            className="bg-white shadow-md rounded-lg p-4 hover:shadow-xl transition-shadow min-h-[22rem]"
          >
            <img
              src={product.image}
              alt={product.name}
