...
const Task4 = observer(() => {
  ...
  const bgGradient =
    theme === 'light' ? 'from-purple-500 to-indigo-600' : 'from-gray-900 to-black';
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        {/* Подсказка */}
        <div
          className={`mt-4 backdrop-blur-sm rounded-lg p-4 ${
        ...
        >
          ...
          >
            <strong>MobX + Zustand:</strong> GameStore управляет игровой логикой
            (observer автообновление), UIStore управляет темой (селекторы). Оба
            работают независимо!
          </p>
        </div>
      </div>
